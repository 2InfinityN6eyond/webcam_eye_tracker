...
if __name__ == "__main__" :
    ...
    landmark_processor_to_eye_tracker_queue = multiprocessing.Queue()
    ...
    face_landmark_processor = FaceLandmarkProcessor(
        ...
        to_tracker_queue= landmark_processor_to_eye_tracker_queue,
        stop_flag       = stop_flag,
    )
    eye_tracker = EyeTracker(
        ...
        face_shm_name   = face_landmark_queue_shm.name,
        shm_queue_size  = args.image_queue_size,
        shm_idx_queue   = landmark_processor_to_eye_tracker_queue,
        stop_flag       = stop_flag
    )
    '''
